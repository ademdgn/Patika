...
namespace ToDoList{
    class Program {
        public static void Main(String[] args){
             Team t1 = new Team(); //creating team members
        t1.TeamMembers.Add(1, "Adem Doğan"); //adding team members by default
        t1.TeamMembers.Add(2, "Melih Doğan");
        t1.TeamMembers.Add(3, "Alperen Doğan");
